...
FLOWABLE.APP_URL = {
    ...
    /* 自定义发布流程模型 */
    getModelBpmn20PublishUrl: function (modelId) {
        return FLOWABLE.CONFIG.webContextRoot + '/model/deploy?modelId='+modelId;
    },
    ...
    getEditorUsersUrl: function () {
        return FLOWABLE.CONFIG.customizeModelerRestRoot + '/rest/editor-users';
    },

    getEditorGroupsUrl: function () {
        return FLOWABLE.CONFIG.customizeModelerRestRoot + '/rest/editor-groups';
    },
